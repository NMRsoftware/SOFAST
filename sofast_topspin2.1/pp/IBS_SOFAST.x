...
"if ( bf2 < 165 ) {sp13=pl2-20*log((p3/25.5832))/log(10); } else{sp13=pl2-20*log((p3/22.1557))/log(10);} "
...
#   ifdef LABEL_CN
  (center (p42:sp26 ph2):f1 (p8:sp13 ph1):f2 (DELTA1 p21 ph3 d21 p21 ph4 DELTA1):f3 )
#   else
